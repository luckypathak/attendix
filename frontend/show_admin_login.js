...
async function launchVisualAdmin() {
  console.log("============================================================");
  console.log("LAUNCHING VISIBLE BROWSER SESSION AND PERFORMING ADMIN LOGIN");
  console.log("============================================================");
  ...
  try {
    ...
    console.log("Typing username: attendix_admin ...");
    await page.type('#username', 'attendix_admin', { delay: 150 }); // 150ms delay per key to simulate human typing
    ...
    console.log("🎉 Successfully logged in as Admin! The browser window will remain open on your screen.");

  } catch (error) {
    console.error("❌ Error during visual admin login:", error);
  }
